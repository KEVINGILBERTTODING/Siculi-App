...
import com.example.siculi.KetuaAdapter.KetuaHistoryPengajuanCutiAtasanAdapter;
import com.example.siculi.KetuaAdapter.KetuaHistoryPengajuanCutiAtasanAdapter;
...
public class KetuaHistoryPengajuanCutiAtasanFragment extends Fragment {
    ...
    KetuaHistoryPengajuanCutiAtasanAdapter ketuaHistoryPengajuanCutiAtasanAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ketua_history_pengajuan_cuti_atasan, container, false);
                ...
                btnDownload.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (tvTglMulai.getText().toString().isEmpty()) {
                            ...
                            String url = DataApi.URL_DOWNLOAD_REKAP_PENGAJUAN_CUTI_ATASAN  + tvTglMulai.getText().toString() + "/" + tvTglSelesai.getText().toString();
                ...
                btnFilter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (tvTglSelesai.getText().toString().isEmpty()) {
                            ...
                            ketuaInterface.filterAllHistoryPengajuanCutiAtasanKetua(
                                ...
                                public void onResponse(Call<List<CutiModel>> call, Response<List<CutiModel>> response) {
                                    if (response.isSuccessful() && response.body().size() > 0) {
                                        ...
                                        ketuaHistoryPengajuanCutiAtasanAdapter = new KetuaHistoryPengajuanCutiAtasanAdapter(getContext(), cutiModelList);
                                        linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                                        rvIzin.setLayoutManager(linearLayoutManager);
                                        rvIzin.setAdapter(ketuaHistoryPengajuanCutiAtasanAdapter);
    ...
    private void getDataCutiKaryawan(){
        ...
        ketuaInterface.ggetAllHistoryPengajuanCutiAtasanKetua().enqueue(new Callback<List<CutiModel>>() {
            @Override
            public void onResponse(Call<List<CutiModel>> call, Response<List<CutiModel>> response) {
                if (response.isSuccessful() && response.body().size() > 0) {
                    cutiModelList = response.body();
    ...
    private void filter(String text) {
        ...
        ketuaHistoryPengajuanCutiAtasanAdapter.filter(filteredList);
