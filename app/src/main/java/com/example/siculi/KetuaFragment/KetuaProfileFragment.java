...
public class KetuaProfileFragment extends Fragment {
    ImageView ivProfile;
    EditText etEmail;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ketua_profil, container, false);
    ...
    private void editMyProfile() {
        if (etNama.getText().toString().isEmpty()) {
            ...
            ketuaInterface.updateMyProfile(map).enqueue(new Callback<ResponseModel>() {
                @Override
    ...
    private void editPhotoProfile() {
            ...
            ketuaInterface.editPhotoProfile(map, image).enqueue(new Callback<ResponseModel>() {
                @Override
                public void onResponse(Call <ResponseModel>call, Response<ResponseModel> response) {
                    if (response.isSuccessful() && response.body().getStatus() == 200) {
