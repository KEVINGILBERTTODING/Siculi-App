...
public class KetuaHistoryDetailPengajuanCutiAtasanfragment extends Fragment {
    CardView cvStatus;
    TextView tvStatus;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = DataApi.URL_DOWNLOAD_SURAT_CUTI_ATASAN_KETUA + idCuti + "/" + getArguments().getString("karyawan_id");
