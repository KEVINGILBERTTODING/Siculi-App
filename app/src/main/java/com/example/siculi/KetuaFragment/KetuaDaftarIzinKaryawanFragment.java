...
import com.example.siculi.KetuaAdapter.KetuaDaftarIzinKaryawanAdapter;
...
public class KetuaDaftarIzinKaryawanFragment extends Fragment {
    ...
    KetuaDaftarIzinKaryawanAdapter ketuaDaftarIzinKaryawanAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ketua_daftar_izin_karyawan, container, false);
                ...
                btnDownload.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (tvTglMulai.getText().toString().isEmpty()) {
                            ...
                            String url = DataApi.URL_DOWNLOAD_REKAP_PENGAJUAN_IZIN_KARYAWAN  + tvTglMulai.getText().toString() + "/" + tvTglSelesai.getText().toString();
...
//                            downloadManager.enqueue(request);
                            ...
                            adminInterface.filterDataIzinKaryawan(
                                ...
                                public void onResponse(Call<List<IzinModel>> call, Response<List<IzinModel>> response) {
                                    if (response.isSuccessful() && response.body().size() > 0) {
                                        ...
                                        ketuaDaftarIzinKaryawanAdapter = new KetuaDaftarIzinKaryawanAdapter(getContext(), izinModelList);
                                        linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                                        rvIzin.setLayoutManager(linearLayoutManager);
                                        rvIzin.setAdapter(ketuaDaftarIzinKaryawanAdapter);
    ...
    private void filter(String text) {
        ...
        ketuaDaftarIzinKaryawanAdapter.filter(filteredList);
