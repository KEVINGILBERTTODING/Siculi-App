...
import com.example.siculi.KetuaAdapter.KetuaAtasanAdapter;
...
public class KetuaAtasanFragment extends Fragment {
    RecyclerView rvAtasan;
    List<AtasanModel> atasanModelList;
    LinearLayoutManager linearLayoutManager;
    KetuaAtasanAdapter ketuaAtasanAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ketua_atasan, container, false);
        ...
        adminInterface.getAllAtasanExceptKetua().enqueue(new Callback<List<AtasanModel>>() {
            ...
            public void onResponse(Call<List<AtasanModel>> call, Response<List<AtasanModel>> response) {
                if (response.isSuccessful() && response.body().size() > 0) {
                    ...
                    ketuaAtasanAdapter = new KetuaAtasanAdapter(getContext(), atasanModelList);
                    linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                    rvAtasan.setLayoutManager(linearLayoutManager);
                    rvAtasan.setAdapter(ketuaAtasanAdapter);
    ...
    private void filter(String text) {
        ...
        ketuaAtasanAdapter.filter(filteredList);
