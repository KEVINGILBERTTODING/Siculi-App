...
public class AtasanHistoryDetailPengajuanCutiAtasanfragment extends Fragment {
    CardView cvStatus;
    TextView tvStatus;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_atasan_history_detail_pengajuan_cuti_atasan, container, false);
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = DataApi.URL_DOWNLOAD_HISTORY_SURAT_CUTI_ATASAN + idCuti + "/" + getArguments().getString("karyawan_id");
