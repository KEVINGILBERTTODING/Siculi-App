...
import com.example.siculi.AtasanAdapter.AtasanHistoryPengajuanIzinKaryawanAdapter;
...
public class AtasanHistoryPengajuanIzinKaryawanFragment extends Fragment {
    ...
    AtasanHistoryPengajuanIzinKaryawanAdapter atasanHistoryPengajuanIzinKaryawanAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_atasan_history_pengajuan_izin_karyawan, container, false);
                            ...
                            atasanInterface.getFilterPengajuanIzinKaryawanProses(
                                ...
                                public void onResponse(Call<List<IzinModel>> call, Response<List<IzinModel>> response) {
                                    if (response.isSuccessful() && response.body().size() > 0) {
                                        ...
                                        atasanHistoryPengajuanIzinKaryawanAdapter = new AtasanHistoryPengajuanIzinKaryawanAdapter(getContext(), izinModelList);
                                        linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                                        rvIzin.setLayoutManager(linearLayoutManager);
                                        rvIzin.setAdapter(atasanHistoryPengajuanIzinKaryawanAdapter);
    ...
    private void getDataIzinKaryawan(){
        ...
        atasanInterface.getAllPengajuanIzinKaryawanByatasanId(userId).enqueue(new Callback<List<IzinModel>>() {
            @Override
            public void onResponse(Call<List<IzinModel>> call, Response<List<IzinModel>> response) {
                if (response.isSuccessful() && response.body().size() > 0) {
                    izinModelList = response.body();
    ...
    private void filter(String text) {
        ...
        atasanHistoryPengajuanIzinKaryawanAdapter.filter(filteredList);
