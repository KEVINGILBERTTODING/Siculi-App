...
public class AtasanIzinFragment extends Fragment {

    RecyclerView rvIzin;
    SearchView searchView;
    AtasanIzinAdapter atasanIzinAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_atasan_izin, container, false);
    ...
    private void getDataIzinAtasan(){
        ...
        atasanInterface.getAllIzin(userId).enqueue(new Callback<List<IzinModel>>() {
            @Override
            public void onResponse(Call<List<IzinModel>> call, Response<List<IzinModel>> response) {
                if (response.isSuccessful() && response.body().size() > 0) {
                    izinModelList = response.body();
    ...
    private void filter(String text) {
        ...
        atasanIzinAdapter.filter(filteredList);
