...
public class AdminIzinKaryawanAdapter extends RecyclerView.Adapter<AdminIzinKaryawanAdapter.ViewHolder> {
    Context context;
    List<IzinModel> izinModelList;
    AdminInterface adminInterface;

    public AdminIzinKaryawanAdapter(Context context, List<IzinModel> izinModelList) {
    ...
    @NonNull
    @Override
    public AdminIzinKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_cuti, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminIzinKaryawanAdapter.ViewHolder holder, int position) {
