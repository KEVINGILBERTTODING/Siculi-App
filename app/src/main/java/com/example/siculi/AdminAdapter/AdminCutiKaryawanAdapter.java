...
public class AdminCutiKaryawanAdapter extends RecyclerView.Adapter<AdminCutiKaryawanAdapter.ViewHolder> {
    Context context;
    List<CutiModel> cutiModelList;
    AdminInterface adminInterface;

    public AdminCutiKaryawanAdapter(Context context, List<CutiModel> cutiModelList) {
    ...
    @NonNull
    @Override
    public AdminCutiKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_cuti, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminCutiKaryawanAdapter.ViewHolder holder, int position) {
