...
import com.example.siculi.AdminAdapter.AdminCutiAtasanAdapter;
...
public class AdminCutiAtasanFragment extends Fragment {

    RecyclerView rvCuti;
    SearchView searchView;
    AdminCutiAtasanAdapter adminCutiAtasanAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_cuti_atasan, container, false);
                ...
                btnFilter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (tvTglSelesai.getText().toString().isEmpty()) {
                            ...
                            adminInterface.filterDataCutiatasan(
                                ...
                                public void onResponse(Call<List<CutiModel>> call, Response<List<CutiModel>> response) {
                                    if (response.isSuccessful() && response.body().size() > 0) {
                                        ...
                                        adminCutiAtasanAdapter = new AdminCutiAtasanAdapter(getContext(), cutiModelList);
                                        linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                                        rvCuti.setLayoutManager(linearLayoutManager);
                                        rvCuti.setAdapter(adminCutiAtasanAdapter);
    ...
    private void getDataCutiAtasan(){
        ...
        adminInterface.getAllCutiAtasan().enqueue(new Callback<List<CutiModel>>() {
            @Override
            public void onResponse(Call<List<CutiModel>> call, Response<List<CutiModel>> response) {
                if (response.isSuccessful() && response.body().size() > 0) {
                    cutiModelList = response.body();
    ...
    private void filter(String text) {
        ...
        adminCutiAtasanAdapter.filter(filteredList);
