...
import com.example.siculi.AdminAdapter.AdminIzinAtasanAdapter;
...
public class AdminIzinAtasanFragment extends Fragment {

    RecyclerView rvIzin;
    SearchView searchView;
    AdminIzinAtasanAdapter adminAtasanIzinAdapter;
                            ...
                            adminInterface.filterDataIzinAtasan(
                                ...
                                public void onResponse(Call<List<IzinModel>> call, Response<List<IzinModel>> response) {
                                    if (response.isSuccessful() && response.body().size() > 0) {
                                        ...
                                        adminAtasanIzinAdapter = new AdminIzinAtasanAdapter(getContext(), izinModelList);
                                        linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                                        rvIzin.setLayoutManager(linearLayoutManager);
                                        rvIzin.setAdapter(adminAtasanIzinAdapter);
    ...
    private void filter(String text) {
        ...
        adminAtasanIzinAdapter.filter(filteredList);
