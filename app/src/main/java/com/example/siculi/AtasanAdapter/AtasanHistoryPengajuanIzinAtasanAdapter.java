...
import com.example.siculi.AtasanFragment.AtasanDetailHistoryPengajuanIzinAtasanFragment;
...
public class AtasanHistoryPengajuanIzinAtasanAdapter extends RecyclerView.Adapter<AtasanHistoryPengajuanIzinAtasanAdapter.ViewHolder> {
    Context context;
    List<IzinModel> izinModelList;
    AdminInterface adminInterface;

    public AtasanHistoryPengajuanIzinAtasanAdapter(Context context, List<IzinModel> izinModelList) {
    ...
    @NonNull
    @Override
    public AtasanHistoryPengajuanIzinAtasanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_izin, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AtasanHistoryPengajuanIzinAtasanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new AtasanDetailHistoryPengajuanIzinAtasanFragment();
