...
public class AtasanHistoryPengajuanIzinKaryawanAdapter extends RecyclerView.Adapter<AtasanHistoryPengajuanIzinKaryawanAdapter.ViewHolder> {
    Context context;
    List<IzinModel> izinModelList;
    AdminInterface adminInterface;

    public AtasanHistoryPengajuanIzinKaryawanAdapter(Context context, List<IzinModel> izinModelList) {
    ...
    @NonNull
    @Override
    public AtasanHistoryPengajuanIzinKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_izin, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AtasanHistoryPengajuanIzinKaryawanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new AtasanDetailHistoryPengajuanIzinKaryawanFragment();
