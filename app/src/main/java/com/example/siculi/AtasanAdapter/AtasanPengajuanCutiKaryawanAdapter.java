...
public class AtasanPengajuanCutiKaryawanAdapter extends RecyclerView.Adapter<AtasanPengajuanCutiKaryawanAdapter.ViewHolder> {
    Context context;
    List<CutiModel> cutiModelList;
    AdminInterface adminInterface;

    public AtasanPengajuanCutiKaryawanAdapter(Context context, List<CutiModel> cutiModelList) {
    ...
    @NonNull
    @Override
    public AtasanPengajuanCutiKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_cuti, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AtasanPengajuanCutiKaryawanAdapter.ViewHolder holder, int position) {
