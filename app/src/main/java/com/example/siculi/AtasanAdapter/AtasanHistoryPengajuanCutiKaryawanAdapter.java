...
import com.example.siculi.AtasanFragment.AtasanDetailPengajuanIzinFragment;
import com.example.siculi.AtasanFragment.AtasanHistoryDetailPengajuanCutiKaryawanfragment;
...
public class AtasanHistoryPengajuanCutiKaryawanAdapter extends RecyclerView.Adapter<AtasanHistoryPengajuanCutiKaryawanAdapter.ViewHolder> {
    Context context;
    List<CutiModel> cutiModelList;
    AdminInterface adminInterface;

    public AtasanHistoryPengajuanCutiKaryawanAdapter(Context context, List<CutiModel> cutiModelList) {
    ...
    @NonNull
    @Override
    public AtasanHistoryPengajuanCutiKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_cuti, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AtasanHistoryPengajuanCutiKaryawanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new AtasanHistoryDetailPengajuanCutiKaryawanfragment();
