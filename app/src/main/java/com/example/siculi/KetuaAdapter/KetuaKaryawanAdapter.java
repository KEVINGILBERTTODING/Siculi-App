...
import com.example.siculi.KetuaFragment.KetuaDetailKaryawanFragment;
...
public class KetuaKaryawanAdapter extends RecyclerView.Adapter<KetuaKaryawanAdapter.ViewHolder> {
    Context context;
    List<KaryawanModel> karyawanModelList;

    public KetuaKaryawanAdapter(Context context, List<KaryawanModel> karyawanModelList) {
    ...
    @NonNull
    @Override
    public KetuaKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_karyawan, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KetuaKaryawanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new KetuaDetailKaryawanFragment();
