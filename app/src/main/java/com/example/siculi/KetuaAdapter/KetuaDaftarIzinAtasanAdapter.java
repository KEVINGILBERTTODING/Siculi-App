...
public class KetuaDaftarIzinAtasanAdapter extends RecyclerView.Adapter<KetuaDaftarIzinAtasanAdapter.ViewHolder> {
    Context context;
    List<IzinModel> izinModelList;
    AdminInterface adminInterface;

    public KetuaDaftarIzinAtasanAdapter(Context context, List<IzinModel> izinModelList) {
    ...
    @NonNull
    @Override
    public KetuaDaftarIzinAtasanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_izin, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KetuaDaftarIzinAtasanAdapter.ViewHolder holder, int position) {
