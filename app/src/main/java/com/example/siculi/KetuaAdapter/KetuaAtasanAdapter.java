...
import com.example.siculi.KetuaFragment.KetuaDetailAtasanFragment;
...
public class KetuaAtasanAdapter extends RecyclerView.Adapter<KetuaAtasanAdapter.ViewHolder> {
    Context context;
    List<AtasanModel> atasanModelList;

    public KetuaAtasanAdapter(Context context, List<AtasanModel> atasanModelList) {
    ...
    @NonNull
    @Override
    public KetuaAtasanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_karyawan, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KetuaAtasanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new KetuaDetailAtasanFragment();
