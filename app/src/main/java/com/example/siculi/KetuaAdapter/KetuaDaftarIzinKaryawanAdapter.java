...
public class KetuaDaftarIzinKaryawanAdapter extends RecyclerView.Adapter<KetuaDaftarIzinKaryawanAdapter.ViewHolder> {
    Context context;
    List<IzinModel> izinModelList;
    AdminInterface adminInterface;

    public KetuaDaftarIzinKaryawanAdapter(Context context, List<IzinModel> izinModelList) {
    ...
    @NonNull
    @Override
    public KetuaDaftarIzinKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_izin, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KetuaDaftarIzinKaryawanAdapter.ViewHolder holder, int position) {
