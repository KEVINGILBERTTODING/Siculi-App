...
public class KetuaHistoryPengajuanCutiKaryawanAdapter extends RecyclerView.Adapter<KetuaHistoryPengajuanCutiKaryawanAdapter.ViewHolder> {
    Context context;
    List<CutiModel> cutiModelList;
    AdminInterface adminInterface;

    public KetuaHistoryPengajuanCutiKaryawanAdapter(Context context, List<CutiModel> cutiModelList) {
    ...
    @NonNull
    @Override
    public KetuaHistoryPengajuanCutiKaryawanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_pengajuan_cuti, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KetuaHistoryPengajuanCutiKaryawanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new KetuaHistoryDetailPengajuanCutiKaryawanfragment();
